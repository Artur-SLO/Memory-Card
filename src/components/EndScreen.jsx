...
export default function EndScreen({message, score, onRestart}) {
    return (
        <StyledWrapper>
            <div className="card">
                ...
                <p className="cookieHeading">{message}</p>
                <p className="cookieDescription">Your final score is {score}</p>
                <div className="buttonContainer">
                    <button className="acceptButton" onClick={onRestart}>Restart</button>
                </div>
            </div>
        </StyledWrapper>
    );
